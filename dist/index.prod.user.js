...
async function NA(url) {
  ...
  if (url.includes('https://www.naughtyamerica.com/scene/')) {
    ...
    workName = document.querySelector('.scene-title').innerText.replace(': ', ' — '); // 系列名

    seriesName = document.querySelector('.site-title').innerHTML; // 日期

    date = moment_default()(infoList.querySelector('.entry-date').innerText).format('YYYY.MM.DD'); // 演员列表
